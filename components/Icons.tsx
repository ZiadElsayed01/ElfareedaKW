...
export function IconTruck({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className}>
      <rect x="2" y="14" width="26" height="18" rx="2" stroke="currentColor" strokeWidth="2.5" />
      <path d="M28 20h9l7 7v5h-16v-12Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
      <circle cx="12" cy="34" r="4" stroke="currentColor" strokeWidth="2.5" />
      <circle cx="35" cy="34" r="4" stroke="currentColor" strokeWidth="2.5" />
      <path d="M2 20h6M2 26h4" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconBox({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" className={className}>
      <path d="M24 6 4 15v18l20 9 20-9V15L24 6Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
      <path d="M4 15l20 9 20-9M24 24v18" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" />
...
export function IconClock({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M12 6v5l3.5 3.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}

export const iconMap = { truck: IconTruck, wrench: IconWrench, box: IconBox, clock: IconClock };
